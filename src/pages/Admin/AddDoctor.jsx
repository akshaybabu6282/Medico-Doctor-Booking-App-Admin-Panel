...
function AddDoctor() {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      <p className='mb-3 text-lg font-bold ms-2 text-cyan-900'>ADD DOCTOR</p>
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <button type='submit' className='bg-cyan-900 px-10 py-3 mt-4 text-white'>Add Doctor</button>
